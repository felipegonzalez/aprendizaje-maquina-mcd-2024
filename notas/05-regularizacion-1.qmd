...
de prueba (como esperaríamos por un aumento en varianza)
3. Sin embargo, si continuamos incrementando la complejidad, el error de prueba
vuelve a descender, y llega a un valor más bajo que todos los observados anteriormente.
